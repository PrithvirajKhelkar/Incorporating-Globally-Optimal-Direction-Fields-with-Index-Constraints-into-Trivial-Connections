...
namespace tcods
{
   ...
   class MeshIO
   {
      public:
         ...
         static void writeOBJX( std::ostream& out, Mesh& mesh, int n_rings ); // writes WavefrontOBJ plus tangent vector per vertex
         static void writeEOBJ( std::ostream& out, const Mesh& mesh, int n_rings ); // writes WavefrontOBJ plus tangent vector per face
